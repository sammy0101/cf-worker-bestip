    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="stats">
                ...
                <div class="stat"><div class="stat-value">${data.lastUpdated ? new Date(data.lastUpdated).toLocaleTimeString('en-US', { timeZone: 'Asia/Hong_Kong', hour12: false }) : '從未'}</div><div>更新時間</div></div>
