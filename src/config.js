...
export const AUTO_TEST_MAX_IPS = 200;        // 定時任務測速最大數量 (建議保持在 45 以下以契合免費版單次 50 次子請求限制)
export const SAFE_SUBREQUEST_LIMIT = 200;    // 子請求安全硬上限，防止免費方案部署時發生異常
...
// 新增：Cloudflare 官方授權的 IPv4 網段白名單 (Definitive Source: https://www.cloudflare.com/ips-v4)
export const CLOUDFLARE_OFFICIAL_CIDRS = [
    "173.245.48.0/20",
    "103.21.244.0/22",
    "103.22.200.0/22",
    "103.31.4.0/22",
